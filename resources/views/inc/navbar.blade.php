<div class="bg-sidebar-dark p-3 push">
    ...
    <div id="horizontal-navigation-hover-normal-dark" class="d-none d-lg-block mt-2 mt-lg-0">
        <ul class="nav-main nav-main-horizontal nav-main-hover nav-main-dark justify-content-between">
            <div class="d-none d-lg-flex nav-main-item justify-content-center align-items-center active text-lg">
                <li>
                    <a aria-current="page" href="/" class="fw-semibold fs-5 tracking-wider text-white me-3">
                        <span class="fw-normal">Easy</span><span class="fw-semibold">2</span><span
                            class="fw-normal">Learn</span>
                    </a>
                </li>
            </div>
            <div class="nav-main-horizontal">
